...
This project explores LLM inference optimization using vLLM, focusing on latency, throughput, batching behaviour, GPU memory usage, and generation parameter tuning. The goal is to understand how inference systems scale under different workloads and how serving configurations affect real-time text generation performance.
